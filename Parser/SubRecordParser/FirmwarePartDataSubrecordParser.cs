...
{
	internal class FirmwarePartDataSubrecordParser: ISubrecordParser
	{
		...
		/// The SRT.
		/// </value>
		public EgtsSubrecordType SRT { get { return EgtsSubrecordType.FirmwarePartData; } }
		...
		{
			var ret = new EgtsFirmwarePartData();
			...
			if (ret.PN == 1)		// так в сырцах, видимо битовые поля будут только у первой части пакета, в документашке это не освещается
			{
